...
public class Anamnese {
	...
	public Anamnese(int codigo, String problemaAnestesia, String problemaHemorragia, String febreReumatica, String problemaRenal,
			String problemaRespitorio, String problemaArticular, String problemaCardiaco, String problemaGastrico,
			String antecedenteFamiliar, String alergia) {
		this.codigo = codigo;
